...
public class UserAccountManageActivity extends BaseActivity{
    private static String TAG = UserAccountManageActivity.class.getSimpleName();
    ...
    public void init() {
        ...
        MainTopTitle.Builder builder = new MainTopTitle.Builder(getString(R.string.user_account_manage));
    ...
    public void setListener() {
        ...
        tvUserModifyPwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //修改密码
                ModifyPwdDialog.Builder builder = new ModifyPwdDialog.Builder(UserAccountManageActivity.this);
    ...
    private void showToast(){
        // 创建一个Toast提示信息
        LayoutInflater inflater = (LayoutInflater) UserAccountManageActivity.this
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.toast_vew, null);
        Toast toast = new Toast(UserAccountManageActivity.this);
