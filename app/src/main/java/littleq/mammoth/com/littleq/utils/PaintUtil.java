...
public class PaintUtil {
    ...
    private static final String SEMI_TRANSPARENT = "#AA3B4375";
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#00000000";
    private static final String DEFAULT_CROPINSIDE_COLOR_ID = "#5Aad4f63";
    private static final float DEFAULT_LINE_THICKNESS_DP = 1;
    private static final float DEFAULT_CORNER_THICKNESS_DP = 5;
    public static final float DEFAULT_GUIDELINE_THICKNESS_PX = 1;
...
//        paint.setColor(Color.WHITE);
    ...
    public static Paint newCropInsidePaint(Context context) {

        final Paint paint = new Paint();
        paint.setColor(Color.parseColor(DEFAULT_CROPINSIDE_COLOR_ID));
